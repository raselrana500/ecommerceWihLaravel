          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
            ...
            <a class="dropdown-item preview-item">
              <div class="preview-thumbnail">
                <img src="{{ asset('public/admin/assets/images/faces/face10.jpg') }}" alt="image" class="img-sm profile-pic">
              </div>
            ...
            <a class="dropdown-item preview-item">
              <div class="preview-thumbnail">
                <img src="{{ asset('public/admin/assets/images/faces/face12.jpg') }}" alt="image" class="img-sm profile-pic">
              </div>
              <div class="preview-item-content flex-grow py-2">
            ...
            <a class="dropdown-item preview-item">
              <div class="preview-thumbnail">
                <img src="{{ asset('public/admin/assets/images/faces/face1.jpg') }}" alt="image" class="img-sm profile-pic">
              </div>
              <div class="preview-item-content flex-grow py-2">
